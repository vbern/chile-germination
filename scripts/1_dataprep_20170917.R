...
#load data
data1 <- read.csv("Rep1_20170917.csv", na.strings=c("","NA"))
data1 <- data1[1:11]
str(data1)

data2 <- read.csv("Rep2_20170917.csv", na.strings=c("","NA"))
data2 <- data2[1:11]
str(data2)

data3 <- read.csv("Rep3_20170917.csv", na.strings=c("","NA"))
data3 <- data3[1:11]
str(data3)

data4 <- read.csv("Rep4_20170917.csv", na.strings=c("","NA"))
data4 <- data4[1:11]
str(data4)
...
times = df.na$number
df.mod <- df.na[rep(row.names(df.na), times), 1:10]
str(df.mod)
