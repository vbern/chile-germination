...
plot(test.trt.1, col = "black", lty = 1:4,
    lwd = 1.75, xlim = c(0,550), conf.int = T
...
plot(test.region.1, col = c("black", "red", "green", "cyan", "blue"), conf.int = T, lwd = 1.40, xlim = c(0,550), 
     #main = "Germination by region"
     )
legend(5, .3, c("Central Valleys", "E Coast", "Sierra Madre de la Sur", "W Coast", "Yucatan" ), 
