...
test.region <- survfit(Surv(end, status) ~ region, data = df, type = "kaplan-meier", conf.type = "log-log")
ggsurvplot(test.region, data =df, conf.int = T, pval = T, palette = "Dark2", risk.table = T, risk.table.col = "strata", xlab = "Time (h)", 
           surv.median.line = "hv")

test.peg <- survfit(Surv(end, status) ~ trt,data = df, type = "kaplan-meier", conf.type = "log-log")
ggsurvplot(test.peg, data =df, conf.int = T, pval = T, palette = rev(brewer.pal(4,"Spectral")), risk.table = T, risk.table.col = "strata", xlab = "Time (h)", 
           surv.median.line = "hv")
...
pegplots <- list()
pegplots[[1]] <- ggsurvplot(test.20, data = df, pval = T, conf.int = T, palette = "Dark2", legend = "none", xlab = "Time (h)", title = "f) 20% [PEG]")
pegplots[[2]] <- ggsurvplot(test.15, data = df, pval = T, conf.int = T, palette = "Dark2", legend = "none", xlab = "Time (h)", title = "g) 15% [PEG]")
pegplots[[3]] <- ggsurvplot(test.10, data = df, pval = T, conf.int = T, palette = "Dark2", legend = "none", xlab = "Time (h)", title = "h) 10% [PEG]")
pegplots[[4]] <- ggsurvplot(test.0, data = df, pval = T, conf.int = T, palette = "Dark2", legend = "none", xlab = "Time (h)", title = "i) 0% [PEG]" )

# Arrange multiple ggsurvplots and print the output
arrange_ggsurvplots(pegplots, title = "Germination under different [PEG]",
                    ncol = 2, nrow = 2)
res <- arrange_ggsurvplots(pegplots, print = FALSE)
ggsave("allconcentrations_20180228.png", res)
...
test.ss <- survfit(Surv(end, status) ~ trt, data = df, type = "kaplan-meier", subset = (region =="sierra sur"))
...
regplots <- list()
regplots[[1]] <- ggsurvplot(test.cv, data = df, pval = T, title = "a) Central Valleys", conf.int = T, legend = "none", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
regplots[[2]] <- ggsurvplot(test.ecoast, data = df, pval = T, title = "b) E Coast", conf.int = T, legend = "none", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
regplots[[3]] <- ggsurvplot(test.ss, data = df, pval = T, title = "c) Sierra Sur", conf.int = T, legend = "none", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
regplots[[4]] <- ggsurvplot(test.wcoast, data = df, pval = T, title = "d) W Coast", conf.int = T, legend = "none", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
regplots[[5]] <- ggsurvplot(test.yucatan, data = df, pval = T, title = "e) Yucatan", conf.int = T, legend = "none", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
...
ggsave("allregions_20180228.png", res)

#COMPARISON OF SURVIVOR FUNCTIONS
library(RColorBrewer)
ggsurvplot(test.cv, data = df, pval = T, title = "Central Valleys", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
...
ggsurvplot(test.ecoast, data = df, pval = T, title = "E Coast", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
...
ggsurvplot(test.wcoast, data = df, pval = T, title = "W Coast", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
...
ggsurvplot(test.ss, data = df, pval = T, title = "Sierra Sur", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
df_sm <- subset(df, region == "sierra sur")
survdiff_sm <- pairwise_survdiff(Surv(end, status)~trt, data = df_sm, p.adjust.method = "bonferroni",rho = 0)
print(survdiff_sm)

ggsurvplot(test.yucatan, data = df, pval = T, title = "Yucatan", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = rev(brewer.pal(4,"Spectral")))
...
ggsurvplot(test.0, data = df, pval = T, title = "0% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
df_0 <- subset(df, trt==0)
survdiff_0 <- pairwise_survdiff(Surv(end, status)~region, data = df_0, p.adjust.method = "bonferroni",rho = 0)
print(survdiff_0)

ggsurvplot(test.10, data = df, pval = T, title = "10% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
df_10 <- subset(df, trt==10)
survdiff_10 <- pairwise_survdiff(Surv(end, status)~region, data = df_10, p.adjust.method = "bonferroni",rho = 0)
print(survdiff_10)

ggsurvplot(test.15, data = df, pval = T, title = "15% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
df_15 <- subset(df, trt==15)
survdiff_15 <- pairwise_survdiff(Surv(end, status)~region, data = df_15, p.adjust.method = "bonferroni",rho = 0)
print(survdiff_15)

ggsurvplot(test.20, data = df, pval = T, title = "20% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
...
ggsurvplot(test.cult.0, data = df, pval = T, title = "(a) Cultivation Systems: 0% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
...
ggsurvplot(test.cult.20, data = df, pval = T, title = "(b) Cultivation Systems: 20% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
...
ggsurvplot(test.domestication.0, data = df, pval = T, title = "0% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
...
ggsurvplot(test.domestication.15, data = df, pval = T, title = "15% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
...
ggsurvplot(test.domestication.20, data = df, pval = T, title = "15% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)", palette = "Dark2")
...
ggsurvplot(test.lr.0, data = df, pval = T, title = "0% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)")
...
test.landrace.ecoast <- survfit(Surv(end, status) ~ landrace.name, data = df_ecoast, subset = {trt == 0}, type = "kaplan-meier", conf.type = "log-log", na.action =na.exclude)
...
ggsurvplot(test.landrace.cv,  conf.int = T, pval = T, xlab = "Time (h)", 
           surv.median.line = "hv", title = "(a) Central Valleys: Germination under Water Control")
...
ggsurvplot(test.lr.20, data = df, pval = T, title = "20% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)")
...
ggsurvplot(test.landrace.cv.20, conf.int = T, pval = T, xlab = "Time (h)", 
...
ggsurvplot(test.landrace.yucatan.20, data =df, conf.int = T, pval = T, risk.table = T, risk.table.col = "strata", 
...
ggsurvplot(test.lr.15, data = df, pval = T, title = "15% PEG", conf.int = T, legend = "bottom", xlab = "Time (h)")
...
test.landrace.ecoast.15 <- survfit(Surv(end, status) ~ landrace.name, data = df_ecoast, subset = {trt == 15}, type = "kaplan-meier", conf.type = "log-log", na.action = na.omit)
...
ggsurvplot(test.landrace.costenorojo.0, data =df, conf.int = T, pval = T, xlab = "Time (h)", 
           surv.median.line = "hv", title = "(a) Costeno Rojo: Germination under 0% PEG")
...
ggsurvplot(test.landrace.costenorojo.15, data =df, conf.int = T, pval = T, risk.table = T, risk.table.col = "strata", xlab = "Time (h)", 
           surv.median.line = "hv", title = "Costeno Rojo: Germination under 15% PEG")
...
ggsurvplot(test.landrace.costenorojo.20, data =df, conf.int = T, pval = T, xlab = "Time (h)", 
           surv.median.line = "hv", title = "(b) Costeno Rojo: Germination under 20% PEG")
...
ggsurvplot(test.landrace.tusta.0, data =df, conf.int = T, pval = T, xlab = "Time (h)", 
           surv.median.line = "hv", title = "(a) Tusta: Germination under 0% PEG")
...
ggsurvplot(test.landrace.tusta.20, data =df, conf.int = T, pval = T, xlab = "Time (h)", 
           surv.median.line = "hv", title = "(b) Tusta: Germination under 20% PEG")
